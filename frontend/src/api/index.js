...
const getOpenSettings = async (message, notification) => {
    try {
        ...
        Object.assign(openSettings.value, {
            ...
            showGithub: typeof res["showGithub"] === 'boolean' ? res["showGithub"] : true,
            hasAdminPasswords: typeof res["hasAdminPasswords"] === 'boolean' ? res["hasAdminPasswords"] : false,
            disableAdminPasswordCheck: res["disableAdminPasswordCheck"] || false,
