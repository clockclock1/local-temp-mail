...
export const createLocalBindings = async (): Promise<Bindings> => {
    ...
    return {
        ...
        ALWAYS_SHOW_ANNOUNCEMENT: process.env.ALWAYS_SHOW_ANNOUNCEMENT || "false",
        ADDRESS_CHECK_REGEX: process.env.ADDRESS_CHECK_REGEX,
        ADDRESS_REGEX: process.env.ADDRESS_REGEX,
        MIN_ADDRESS_LEN: process.env.MIN_ADDRESS_LEN,
        MAX_ADDRESS_LEN: process.env.MAX_ADDRESS_LEN,
        ...
        ENABLE_GLOBAL_TURNSTILE_CHECK: process.env.ENABLE_GLOBAL_TURNSTILE_CHECK || "false",
